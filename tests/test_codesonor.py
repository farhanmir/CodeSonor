...
class TestLLMProviders:
    ...
    def test_import_providers(self):
        ...
        from codesonor.llm_providers import SUPPORTED_PROVIDERS, get_provider
    ...
    def test_repository_analyzer_llm_params(self):
        ...
        analyzer = RepositoryAnalyzer(
            github_token=None, gemini_key=None, llm_provider="openai", llm_model="gpt-4"
        )
...
class TestNewFeaturesV040:
    ...
    def test_import_rules_engine(self):
        ...
        from codesonor.rules_engine import Rule, RulesEngine
    ...
    def test_import_dashboard(self):
        ...
        from codesonor.dashboard import DashboardSimple, InteractiveDashboard
